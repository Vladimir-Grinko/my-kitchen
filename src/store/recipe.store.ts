...
export const useRecipeStore = create<IRecipeState>((set) => ({
  ...
  loadRecipes: async () => {
    ...
    try {
      ...
      console.log("Ошибка при получении рецептов", error);
      set({ error: "Ошибка при получении рецептов", isLoading: false });
    }
  },
  addRecipe: async (formData: FormData) => {
    ...
    try {
      ...
      console.log("Ошибка при добавлении рецепта", error);
  ...
  updateRecipe: async (id: string, formData: FormData) => {
    ...
    try {
      ...
      console.log("Ошибка при обновлении рецепта", error);
